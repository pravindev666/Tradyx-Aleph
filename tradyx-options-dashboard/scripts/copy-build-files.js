...
/**
 * Copy platform-specific files to out directory after Next.js build
 * This ensures _headers and _redirects are available for Cloudflare Pages deployment
...
console.log('📋 Copying platform files to out directory...');
