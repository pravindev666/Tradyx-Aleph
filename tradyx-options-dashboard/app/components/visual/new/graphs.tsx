...
function BarRow({ dark, label, value, pct, positive }: BarRowProps) {
  return (
    <div>
...
function GammaHeat({ dark, rows }: GammaHeatProps) {
...
function IVSmile({ dark, rows }: IVSmileProps) {
...
function Sparkline({ series, stroke = '#3b82f6', height = 36, width = 120 }: SparklineProps) {
...
export { BarRow, GammaHeat, IVSmile, Sparkline };